...
extension GLib
{
	...
	[LinkName("g_bit_lock_and_get")] public static extern void BitLockAndGet(gint* address, guint lock_bit, gint* out_val);
	...
	[LinkName("g_bit_unlock_and_set")] public static extern void BitUnlockAndSet(gint* address, guint lock_bit, gint new_val, gint preserve_mask);
...
extension GLib
{
	...
	[LinkName("g_date_get_week_of_year")] public static extern guint DateGetWeekOfYear(GDate* date, GDateWeekday first_day_of_week);
	...
	[LinkName("g_date_get_weeks_in_year")] public static extern guint8 DateGetWeeksInYear(GDateYear year, GDateWeekday first_day_of_week);
...
extension GLib
{
	...
	[LinkName("g_source_dup_context")] public static extern GMainContext* SourceDupContext(GSource* source);
...
extension GLib
{
	...
	[LinkName("g_string_copy")] public static extern GString* StringCopy(GString* string);
...
extension GLib
{
	...
	[LinkName("g_log_get_always_fatal")] public static extern GLogLevelFlags LogGetAlwaysFatal();
}
...
static
{
	[LinkName("_g_log_fallback_handler")] public static extern void LogFallbackHandler(gchar* log_domain, GLogLevelFlags log_level, gchar* message, gpointer unused_data);
}
...
extension GLib
{
	[LinkName("glib_check_version")] public static extern gchar* libCheckVersion(guint required_major, guint required_minor, guint required_micro);
